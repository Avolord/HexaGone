...
{
    public class FieldMovementRateModifier : FieldModifier
    {
        //Attributes
        ...
        private const int modifierExampleAdditiveModifier = 42;
        ...
        public FieldMovementRateModifier(Field parentField, int modifierID, double value = 1)
        {
            if (parentField != null)
            {
                ...
                switch (ModifierID)
                {
                    ...
                    case modifierTerrain:
                        ...
                        Value = ParentField.FieldTerrain.BaseMovementRate;
                        break;
                    ...
                    case modifierExampleAdditiveModifier:
